...
// export default function LaunchProcess() {
//   const [nombreUsuario, setNombreUsuario] = useState<string>(""); // ahora se guarda el nombre del usuario real
//   const navigate = useNavigate();
...
//       setNombreUsuario(data.first_name || "Usuario"); // Ajusta según el nombre del campo (ej: data.name, data.nombre, etc.)
//     } catch (err) {
...
//         Te damos la bienvenida a WhisperTrend
//       </p>
//       <p className="text-xl mt-10 text-center">
