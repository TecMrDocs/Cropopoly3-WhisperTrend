/**
* Componente de gráfico de tendencias uniformes para análisis comparativo.
* 
* Este componente renderiza gráficos de líneas que muestran tendencias promedio
* de diferentes métricas (ventas, hashtags, noticias) a lo largo del tiempo.
* Incluye datos específicos para cada tipo de análisis, colores temáticos,
* tooltips informativos y descripciones contextuales para facilitar la
...
/**
* Interfaces para tipos de datos del componente.
* 
* Define la estructura de datos para períodos con promedios
* y las props del componente principal.
*/
...
/**
* Datos específicos para cada tipo de análisis.
* 
* Contiene métricas históricas organizadas por categorías:
* ventas, hashtags de redes sociales y noticias relevantes.
*/
const datosPorTipo = {
 ventas: [
...
/**
* Configuración de metadatos por tipo de análisis.
* 
* Define títulos, colores y descripciones específicas para cada
* categoría de datos a visualizar.
*/
const titulos = {
...
/**
* Componente principal de gráfico de tendencias uniformes.
* 
* Renderiza gráficos de líneas con promedios calculados de múltiples métricas
* para diferentes tipos de análisis (ventas, hashtags, noticias).
* 
* @param tipo - Tipo de análisis a mostrar (hashtag1 por defecto)
* @return JSX.Element - Gráfico de líneas con tendencias y descripción
*/
const TendenciaUniforme: React.FC<TendenciaUniformeProps> = ({ tipo = 'hashtag1' }) => {
 const datosActuales = datosPorTipo[tipo];
 
 /**
  * Calcula promedios generales por período temporal.
  * 
  * @return PromedioPorPeriodo[] - Array con promedios por período
  */
